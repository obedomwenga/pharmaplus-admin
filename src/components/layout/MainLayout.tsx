...
const MainLayout: React.FC<MainLayoutProps> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-background-primary text-text-primary flex">
      {/* Sidebar */}
      <aside className="sidebar w-64 bg-pharma-green-dark text-white flex-shrink-0 fixed h-full shadow-card z-10">
        <div className="flex items-center justify-center h-16 border-b border-opacity-20 border-pharma-green-light">
          <h1 className="text-xl font-bold">PharmaPlus Admin</h1>
        </div>
