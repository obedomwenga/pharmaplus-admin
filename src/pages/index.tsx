      ...
      <div>
          ...
          <div className="bg-white p-6 rounded-lg border border-pharma-gray-dark shadow-card">
            <div className="flex justify-between items-start">
              <div>
                ...
                <h3 className="text-3xl font-bold text-text-primary mt-1">{promotions.length}</h3>
              </div>
          ...
          <div className="bg-white p-6 rounded-lg border border-pharma-gray-dark shadow-card">
            <div className="flex justify-between items-start">
              <div>
                ...
                <h3 className="text-3xl font-bold text-text-primary mt-1">{activePromotions}</h3>
              </div>
          ...
          <div className="bg-white p-6 rounded-lg border border-pharma-gray-dark shadow-card">
            <div className="flex justify-between items-start">
              <div>
                ...
                <h3 className="text-3xl font-bold text-text-primary mt-1">{expiringSoon}</h3>
              </div>
        ...
        <div className="bg-white p-6 rounded-lg border border-pharma-gray-dark shadow-card">
          <div className="flex justify-between items-center mb-6">
            <h3 className="text-lg font-semibold text-text-primary">Recent Promotions</h3>
              ...
              <table className="min-w-full divide-y divide-pharma-gray-dark">
                <thead className="bg-pharma-gray">
                  <tr>
                    ...
                    <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-text-secondary uppercase tracking-wider">Discount</th>
                    <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-text-secondary uppercase tracking-wider">Status</th>
                    <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-text-secondary uppercase tracking-wider">End Date</th>
                    <th scope="col" className="px-6 py-3 text-right text-xs font-medium text-text-secondary uppercase tracking-wider">Action</th>
                  </tr>
                </thead>
